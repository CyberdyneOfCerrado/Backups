...
public class BancoDeDados 
{
	...
	final Tabela artefato    = new Tabela("ARTEFATO","CREATE TABLE ARTEFATO(PRIMARYKEY INT NOT NULL GENERATED ALWAYS AS IDENTITY(START WITH 1, INCREMENT BY 1),NOME VARCHAR(10000), ULTIMAMODIFICACAO VARCHAR(31) ,FK INT NOT NULL,PRIMARY KEY (PRIMARYKEY),CONSTRAINT fk_ARTEFATO_VERSAO1 FOREIGN KEY (FK) REFERENCES VERSAO(PRIMARYKEY))");
