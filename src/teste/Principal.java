...
public class Principal {
	public static void main (String [] args ){
		...
		/*
			...
			Backup b = new Backup("Meus codigos Javascript",new Date().toString(), new RegraBackup("Merda13","Merda2"));
			...
			for( int x = 0 ; x < 2 ; x++ ) b.getRegra().salvarDia(new Dias(DiasSemana.SABADO, new Date().toString().substring(17,19)+x,false));
